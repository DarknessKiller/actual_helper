...
func RegisterConvertRoutes(server *fuego.Server, convertHandler *ConvertHandler) {
	fuego.Post(server, "/convert/{provider}", convertHandler.Convert,
		...
		option.Path("provider", "any supported providers", param.Example("Touch n Go", "tng"), param.Example("RYT Bank", "ryt"), param.Example("HSBC Credit", "hsbccredit"), param.Example("UOB Credit", "uobcredit")),
